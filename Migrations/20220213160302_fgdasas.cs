...
{
    public partial class fgdasas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Competes", x => x.CompeteId);
                    table.ForeignKey(
                        name: "FK_Competes_Competitions_CompetitionId",
                        column: x => x.CompetitionId,
                        principalTable: "Competitions",
                        principalColumn: "CompetitionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Competes_Players_PlayerOneId",
                        column: x => x.PlayerOneId,
                        principalTable: "Players",
                        principalColumn: "PlayerId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Competes_Players_PlayerTwoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Registers_Competitions_CompetitionId",
                        column: x => x.CompetitionId,
                        principalTable: "Competitions",
                        principalColumn: "CompetitionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Registers_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Players",
                        principalColumn: "PlayerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Competes_CompetitionId",
                table: "Competes",
                column: "CompetitionId");

            migrationBuilder.CreateIndex(
                name: "IX_Competes_PlayerOneId",
                table: "Competes",
                column: "PlayerOneId");

            migrationBuilder.CreateIndex(
                name: "IX_Competes_PlayerTwoId",
                table: "Competes",
                column: "PlayerTwoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registers_CompetitionId",
                table: "Registers",
                column: "CompetitionId");

            migrationBuilder.CreateIndex(
                name: "IX_Registers_PlayerId",
                table: "Registers",
                column: "PlayerId");
        }
